...
__attribute__((section("__versions"))) = {
	...
	{ 0xe7744c63, __VMLINUX_SYMBOL_STR(put_pid) },
	...
	{ 0x7578cd47, __VMLINUX_SYMBOL_STR(snd_ctl_get_preferred_subdevice) },
